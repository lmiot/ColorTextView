package com.lmiot.colortextviewlibrary;
...
public class ColorTextView extends TextView {
    ...
    private void initData(AttributeSet attrs) {
        TypedArray typedArray = getContext().getTheme().obtainStyledAttributes(attrs, R.styleable.ColorTextView, 0, 0);
        mColor01 = typedArray.getColor(R.styleable.ColorTextView_color01, Color.BLACK);
        mColor02 = typedArray.getColor(R.styleable.ColorTextView_color02, Color.BLACK);
        mSize01 = typedArray.getInt(R.styleable.ColorTextView_size01, 10);
        mSize02 = typedArray.getInt(R.styleable.ColorTextView_size02, 10);
        mText01 = typedArray.getString(R.styleable.ColorTextView_text01);
        mText02 = typedArray.getString(R.styleable.ColorTextView_text02);
